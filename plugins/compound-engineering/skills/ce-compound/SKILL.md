...
2. If the block is absent, empty, or this is a non-Claude-Code platform, skip this step and proceed to Phase 1 unchanged. Do NOT Glob, Grep, `ls`, or otherwise search the filesystem for MEMORY.md
